...
<script>
var Funds=Funds||{detail:function(fund_id){var url='<?=url('funds/fundDetail')?>?fund_id='+fund_id;mApp.go('基金信息',url);},projects:function(fund_id){var url='<?=url('funds/projects')?>?fund_id='+fund_id;mApp.go('投资项目',url);}};</script>