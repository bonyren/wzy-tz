...
<script>
var <?=JVAR?>={datagrid:'#<?=DATAGRID_ID?>',convert:function(data){var that=<?=JVAR?>;data.rows.forEach(function(v,i){$(that.datagrid).datagrid('updateRow',{index:i,row:{stock_ratio:v.stock_ratio+'%',}});});}};</script>
