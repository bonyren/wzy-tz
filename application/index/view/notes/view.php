...
<script>
$('#F6<?=UNIQID?>').attachesComplex({attachmentType:<?=\app\index\logic\Upload::ATTACH_PROGRESS_LOGS?>,externalId:'<?=$row['progress_log_id']?>',readOnly:true,fit:true,title:'附件列表'});</script>