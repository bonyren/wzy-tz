<form>
	<table class="table-form" cellpadding="5">
		...
		<tr>
			...
			<td><input class="easyui-numberbox" min="0" max="10000" name="data[order_id]" value="<?=$row['order_id']??0?>" style="width:100%"></td>
		</tr>
		<tr>
			<td class="field-label">模块</td>
			<td><input class="easyui-textbox" name="data[m]" value="<?=$row['m']??''?>" style="width:100%"></td>
		</tr>
		<tr>
