        ...
        <form id="scientist-save-form" method="post">
            <table class="table-form" cellpadding="2">
                ...
                <tr>
                    ...
                    <td class="field-input">
                        <textarea id="brief-introduction-textbox" class="easyui-textbox" name="infos[brief_introduction]" data-options="width:'100%',height:'auto',multiline:true"><?=$infos['brief_introduction']?></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="field-label">核心技术:</td>
                    <td class="field-input">
                        <textarea id="core-tech-textbox" class="easyui-textbox" name="infos[core_tech]" data-options="width:'100%',height:'auto',multiline:true,validType:['length[1,1024]']"><?=$infos['core_tech']?></textarea>
                    </td>
                </tr>
                <tr>
...
setTimeout(function(){$("#brief-introduction-textbox").textbox('autoHeight');$("#core-tech-textbox").textbox('autoHeight');},200);</script>