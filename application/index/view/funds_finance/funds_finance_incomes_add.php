<form method="post" style="width: 100%;height: 100%;">
    <table class="table-form" cellpadding="5">
        <tr class="form-caption">
            <td colspan="2">添加收入</td>
        </tr>
        <tr>
            <td class="field-label" style="width: 150px;">类型:</td>
            ...
            <td>
                <?php foreach(\app\index\logic\Defs::$fundTaxTypeDefs as $key=>$title){ ?>
                    <div class="mt-1">
                        ...
                        <input class="easyui-numberbox" id="tax_<?=$key?>" name="infos[tax][<?=$key?>]" data-options="label:'<?=$title?>',labelWidth:200,width:360,min:0,precision:2,disabled:true" value="0.00" />元
                    </div>
                <?php } ?>
            </td>
        </tr>
