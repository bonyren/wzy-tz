        ...
        <div id="attaches_<?=$uniqid?>" class="clearfix">
            <?php foreach($bindValues['attaches'] as $attach){ ?>
                <div id="attach_file_<?=$uniqid?>_<?=$attach['attachment_id']?>" class="attach-box">
                    ...
                    <div class="text-center mt-1 attach-name">
