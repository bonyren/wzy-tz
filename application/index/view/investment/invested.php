...
var addInvestmentTab=function(){EnterpriseModule.addInvestment('<?=$enterprise_id?>',function(){var tab=$('#enterprise_edit_view').tabs('getSelected');tab.panel('refresh');})};</script>