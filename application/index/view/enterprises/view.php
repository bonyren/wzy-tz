    ...
    <div title="投后管理" border="false" iconCls="fa fa-square">
        <div class="easyui-tabs" fit="true" border="false">
            ...
            <div title="投后支持" iconCls="fa fa-square"
                 href="<?=url('ProgressLogs/light',['category'=>ProgressLogs::PROGRESS_LOG_INVESTED_SUPPORT_CATEGORY,'externalId'=>$row['id'],'readOnly'=>1])?>">
            </div>
            <div title="公司动态"
                 href="<?=url('ProgressLogs/light',['category'=>ProgressLogs::PROGRESS_LOG_INVESTED_ACTIVITY_CATEGORY,'externalId'=>$row['id'],'readOnly'=>1])?>">
            </div>
