...
<script>
var dbBackupsModule={dialog:'#globel-dialog-div',datagrid:'#dbBackupsDatagrid',operate:function(val,row){var btns=[];btns.push('<a href="javascript:;" class="btn btn-outline-default size-MINI radius" onclick="dbBackupsModule.delete(\''+row.name+'\')" title="删除"><i class="fa fa-trash-o fa-lg"></i></a>');return btns.join(' ');},delete:function(name){}};</script>