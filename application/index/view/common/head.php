...
<?php require APP_PATH . 'index' . DS . 'view' . DS . 'common/theme.php'; ?>
...
<script>
window.loginMobile=<?=json_encode($loginMobile)?>;var iconClsDefs=<?=json_encode(\app\index\logic\Defs::$iconClsDefs,JSON_UNESCAPED_SLASHES|JSON_UNESCAPED_UNICODE)?>;</script>