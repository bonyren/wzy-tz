...
var FFE_<?=$uniqid?>={save:function(){var ffeId=0;$('#Form_<?=$uniqid?>').form('submit',{onSubmit:function(){var href='<?=$urlHrefs['fundEnterprise']?>';var isValid=$(this).form('validate');if(!isValid)return false;$.ajaxSettings.async=false;$.post(href,$(this).serialize(),function(res){if(!res.code){}else{ffeId=res.data;}},'json');$.ajaxSettings.async=true;return false;}});return ffeId;}};</script>