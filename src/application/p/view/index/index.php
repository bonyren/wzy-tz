...
<!--    <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">-->
    ...
    <script type="text/javascript">
        ...
        var iconClsDefs = <?=json_encode(\app\index\logic\Defs::$iconClsDefs, true)?>;
    </script>
</head>
        ...
        <ul class="nav-right">
            <li>
                ...
                ?>
                    ...
                    data-options="menu:'#toparea-help-box',iconCls:'fa fa-question-circle'">帮助
                    </a>
...
var root = {
    ...
    password: function(){
        var that = this;
        var href = '<?=url('index/password')?>';
        QT.helper.dialog('修改密码',href,true,function($dialog){
            var $form = $('#my-password-form');
