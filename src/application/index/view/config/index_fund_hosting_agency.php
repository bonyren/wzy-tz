...
<script type="text/javascript">
    var fundHostingAgencyModule = {
        dialog:   '#globel-dialog-div',
        datagrid: '#fundHostingAgencyDatagrid',
        //工具栏
        toolbar: [
            { text: '添加', iconCls: iconClsDefs.add, handler: function(){fundHostingAgencyModule.add();} },
            { text: '刷新', iconCls: 'fa fa-refresh', handler: function(){fundHostingAgencyModule.refresh();} }
        ],
        operate: function(val, row ,index){
            var btn = [];
            btn.push('<a href="javascript:;" onclick="fundHostingAgencyModule.edit('+row.id+')"><i class="fa fa-pencil-square-o fa-lg"></i></a>');
            btn.push('<a href="javascript:;" onclick="fundHostingAgencyModule.delete('+row.id+')"><i class="fa fa-trash-o fa-lg"></i></a>');
            return btn.join(' | ');
        },
        refresh: function(){
    ...
    for(var key in options){
        if(key=='toolbar'){
            options[key] = fundHostingAgencyModule.toolbar;
        }
    }
    $('#fundHostingAgencyDatagrid').datagrid(options);
</script>