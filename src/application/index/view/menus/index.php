...
var <?=JVAR?> = {
    ...
    toolbar:[
        { text: '添加', iconCls: 'icons-my-edit_add', handler: function(){<?=JVAR?>.save();} },
        { text: '删除', iconCls: 'icons-my-edit_remove', handler: function(){<?=JVAR?>.del();} },
        { text: '刷新', iconCls: 'icons-my-reload', handler: function(){<?=JVAR?>.reload();} }
    ],
