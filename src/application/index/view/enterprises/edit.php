    ...
    <div title="投后管理" cache="false" border="false" iconCls="fa fa-square">
        <div class="easyui-tabs" fit="true" border="false">
            ...
            <div title="投后支持" iconCls="fa fa-square"
                 href="<?=url('ProgressLogs/light',['category'=>ProgressLogs::INVESTED_SUPPORT_CATEGORY,'externalId'=>$enterprise['id']])?>">
            </div>
            <div title="公司动态"
                 href="<?=url('ProgressLogs/light',['category'=>ProgressLogs::INVESTED_PROGRESS_CATEGORY,'externalId'=>$enterprise['id']])?>">
            </div>
