			...
			'insertimage': {
				...
				onClick: function(){
					var content = 
							...
							'<input class="easyui-textbox img-src" label="Source:" labelAlign="right" style="width:90%">' +
							'</div>' +
							'<div style="margin-bottom:20px">' +
							'<input class="easyui-textbox img-alt" label="Description:" labelAlign="right" style="width:90%">' +
							'</div>' +
							'<div style="margin-bottom:20px">' +
							'<input class="easyui-numberbox img-width" label="Width:" labelAlign="right" style="width:45%">' +
							'<input class="easyui-numberbox img-height" label="Height:" labelAlign="right" style="width:45%">' +
							'</div>' +
							'</div>';
